/* =====================================================
   ...
   - Prayer request + Newsletter form (placeholder)
   - Sermon filters (placeholder)
   ===================================================== */
...
(function(){
  ...
  CHURCHES.forEach(c => {
    ...
    m.bindPopup(`<strong>${c.name}</strong><span class="pop-pastor">${c.pastor}</span><div class="pop-meta">${c.city}, ${c.province}<br/>${c.services[0]}</div>`);
  ...
  document.getElementById('ajnc-q').addEventListener('input', e => {
...
/* ============ Sermon filters (chip toggle, no actual filtering since data is static placeholder) ============ */
(function(){
