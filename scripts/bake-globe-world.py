...
slightly right of center with north up. The beacon sits on Cebu; arc endpoints
...
# globe3d.js computes the initial yaw that brings the beacon front-center. ----
...
js = (
    ...
    "   Philippines-centered, beacon on Cebu, arcs to real cities.\n"
    "   Do not edit by hand. */\n"
    "window.AJNC_GLOBE = {\n"
    f"  count: {N},\n"
    f"  frontCount: {N},\n"
