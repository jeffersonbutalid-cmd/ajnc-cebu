...
insert into public.churches (slug, name, region, province, city, address, pastor, services, phone, website, lat, lng, sort_order) values
  ('cebu',       'AJNC Cebu',           'visayas',  'Cebu',              'Mandaue City',  '2nd Floor, Un Heng Building, Casuntingan, Mandaue City, Cebu',   'Pastor Mario Doromal',     '["Sunday 10:00 AM","Sunday 3:00 PM","Thursday 6:30 PM"]', null, '#top',                          10.3242, 123.9398, 1),
  ...
  ('dipolog',    'AJNC Dipolog',        'mindanao', 'Zamboanga del Norte', 'Dipolog City',  'H8JV+36R, Katipunan Street, Dipolog City, Zamboanga del Norte',  'Pastor Jude Vasquez',      '["Sunday 10:00 AM","Sunday 3:00 PM","Bible Study Thursday 6:30 PM","Prayer Meeting Tuesday 6:30 PM"]', null, '/microsite/?church=dipolog',    8.5889,  123.3414, 8)
