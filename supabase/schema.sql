...
insert into public.churches (slug, name, region, province, city, address, pastor, services, phone, website, lat, lng, sort_order) values
  ...
  ('dipolog',    'AJNC Dipolog',        'mindanao', 'Zamboanga del Norte', 'Dipolog City',  'Katipunan Street, Dipolog City, Zamboanga del Norte',  'Pastor Jude Vasquez',      '["Sunday 10:00 AM","Sunday 3:00 PM","Bible Study Thursday 6:30 PM","Prayer Meeting Tuesday 6:30 PM"]', '0915 358 7827', '/microsite/?church=dipolog',    8.5889,  123.3414, 8)
